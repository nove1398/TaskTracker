            ...
            modelBuilder.Entity("TaskTracker.Models.AssignedTasks", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 7, 18, 4, 51, 28, 228, DateTimeKind.Utc).AddTicks(9020));
            ...
            modelBuilder.Entity("TaskTracker.Models.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 18, 4, 51, 28, 225, DateTimeKind.Utc).AddTicks(6431));
            ...
            modelBuilder.Entity("TaskTracker.Models.Tasks", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 18, 4, 51, 28, 228, DateTimeKind.Utc).AddTicks(8163));
